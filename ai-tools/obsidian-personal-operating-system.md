...
- **前置阅读：** [Obsidian Vault 检索优先组织方法论（本篇的纯组织版前身）](../../productivity/obsidian-vault-organization-full-course.md) — 如果没有 AI 自动化需求，7 文件夹版已足够
- [搭建 Obsidian Vault 自动运转业务](./obsidian-business-ops-vault-with-claude-n8n.md) — 同一架构的商业场景变体
- [Obsidian 仪表盘完整指南](./obsidian-dashboard-everything-that-matters-today.md) — Dataview 仪表盘构建
- [小白入门教程](./obsidian-beginner-complete-tutorial.md) — 安装与插件指南
